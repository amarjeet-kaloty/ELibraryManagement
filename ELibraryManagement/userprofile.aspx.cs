        ...
        void updateUserPersonalDetails()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("UPDATE member_master_tbl SET full_name=@full_name, dob=@dob, contact_no=@contact_no, email=@email, " +
                    "state=@state, city=@city, pincode=@pincode, full_address=@full_address, password=@password, account_status=@account_status " +
        ...
        void getUserPersonalDetails()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("SELECT * FROM member_master_tbl WHERE " +
                    "member_id='" + Session["username"].ToString() + "';", con);
                ...
                TextBox6.Text = dt.Rows[0]["state"].ToString();
