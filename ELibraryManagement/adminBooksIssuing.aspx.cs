...
{
    public partial class adminBooksIssuing : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            if(checkIfBookExist() && checkIfMemberExist())
            {
                ...
                {
                    Response.Write("<script>alert('Member is already issued this book.');</script>");
                }
                else
                {
                    issueBook();
            ...
            {
                Response.Write("<script>alert('Incorrect Book or Member Id.');</script>");
            }
        }
        ...
        bool checkIfIssueEntryExist()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("SELECT * FROM book_issue_tbl WHERE book_id= '" + TextBox2.Text.Trim() + "' AND member_id= '" + TextBox1.Text.Trim() +"'", con);
